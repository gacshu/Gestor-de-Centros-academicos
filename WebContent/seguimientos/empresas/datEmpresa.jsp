...
<%@page import="es.jahernandez.gestion.EmpresasGestion"%>
...
{
    empVO = EmpresasGestion.devolverDatEmp(request.getParameter("codEmp"));
}
...
<div id="segEmp" name="segEmp" title="Seguimientos">
   <iframe name="fraSeg"     id="fraSeg"     frameborder="0" src="../segEmp/verSegEmp.jsp?codEmp=<%=empVO.getIdEmpresa()%>" style="width:100%" height="300" scrolling="no"> </iframe>
</div>
...
<table style="width:100%" border="0">
  ...
  <tr>
    <td style="width:50%" class="cellBtnSub"><input class="cellBtnSub" type="button" name="btnSeg" id="btnSeg" value="Seguimientos" onclick="$('#segEmp').dialog('open');" /></td>
    <td style="width:50%" class="cellBtnSub"><input class="cellBtnSub" type="button" name="btnVolver" id="btnVolver" value="Volver" onclick="window.open('./RBEmpresas.jsp?ind=<%=indLista%>','_self','')" /></td>
  </tr>
  <tr>
