...
public class TablaEdiciones
{
    ...
    public static final String PLAZAS       = "NumPla";
    public static final String HORAS        = "NumHor";
    public static final String HORAINICIO   = "HorIn";
    public static final String HORAFIN      = "HorFin";
    public static final String PRECIOMATRIC = "PrecioM";
    public static final String PRECIORECIBO = "PrecioR";
    ...
    public static final String MINUTOINICIO = "MinIn";
    public static final String MINUTOFIN    = "MinFin";
    public static final String HORASDISTAN  = "HorDis";
    public static final String HORASTELEF   = "HorTelf";
    public static final String CODAULA      = "idAula";
    public static final String BONIFICADO   = "bonif";
    public static final String PLAZOS       = "Plazos";
    public static final String PAGOENERO    = "Ene";
    public static final String PAGOFEBRERO  = "Feb";
    public static final String PAGOMARZO    = "Mar";
    public static final String PAGOABRIL    = "Abr";
    public static final String PAGOMAYO     = "May";
