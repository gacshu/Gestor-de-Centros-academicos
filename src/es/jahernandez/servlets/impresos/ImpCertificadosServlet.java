            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            for (int ind = 0; ind < listaAlu.size(); ind++)
            {
                ...
                parCert.setAlignment(Element.ALIGN_CENTER);

                parNomAlum.font().setSize(20);
                parNomAlum.setAlignment(Element.ALIGN_CENTER);
                parDatCur.font().setSize(20);
                parDatCur.setAlignment(Element.ALIGN_CENTER);
                parLugCur.font().setSize(20);
                parLugCur.setAlignment(Element.ALIGN_CENTER);
                parAprov.font().setSize(20);
                parAprov.setAlignment(Element.ALIGN_CENTER);
