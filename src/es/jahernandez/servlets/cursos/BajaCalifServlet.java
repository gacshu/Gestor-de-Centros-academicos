 ...
 * @author JuanAlberto
 */
public class BajaCalifServlet extends HttpServlet
{
    ...
    throws ServletException, IOException
    {
        ...
        if(request.getParameter("hidFecha" + califVO.devolverClave()) != null &&
          !request.getParameter("hidFecha" + califVO.devolverClave()).equals(""))
        {
        ...
        resBaj = CalificacionesGestion.eliminaCalificacion(califVO.getIdEdi(),califVO.getIdMod(),califVO.getIdAlu(),califVO.getEvaluacion());
    ...
    {
        return "Baja calificación individual Servlet";
    }// </editor-fold>
}
