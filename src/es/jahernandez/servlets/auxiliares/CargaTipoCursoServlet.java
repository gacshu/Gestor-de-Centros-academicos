...
public class CargaTipoCursoServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
                ...
                for (int ind = 0; ind<vecTipCur.size(); ind ++)
                {
                    ...
                    {
                            if(valSel.trim().equals(String.valueOf(tipCurVO.getIdTipoCurso()) ))
                            {
                                out.printf("<option value='%1s' selected='selected'>%2s</option>",  tipCurVO.getIdTipoCurso() , tipCurVO.getNomTipCurso());
                            }
                            else
                            {
                                out.printf("<option value='%1s'>%2s</option>",  tipCurVO.getIdTipoCurso() , tipCurVO.getNomTipCurso());
    ...
    public String getServletInfo() {
        return "Servlet que carga combo tipo curso";
    }// </editor-fold>
