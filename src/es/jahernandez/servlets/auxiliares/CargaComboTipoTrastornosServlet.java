...
public class CargaComboTipoTrastornosServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            for (int ind = 0; ind<vecTipTras.size(); ind ++)
            {
                ...
                {
                        if(valSel.trim().equals(tipTrastVO.getCodTipTrast()))
                        {
                            out.printf("<option value='%1s' selected='selected'>%2s</option>", tipTrastVO.getCodTipTrast(), tipTrastVO.getDescrip());
                        }
                        else
                        {
                            out.printf("<option value='%1s'>%2s</option>", tipTrastVO.getCodTipTrast(), tipTrastVO.getDescrip());
    ...
    public String getServletInfo() {
        return "Servlet que carga combo tipo trastorno";
    }// </editor-fold>
